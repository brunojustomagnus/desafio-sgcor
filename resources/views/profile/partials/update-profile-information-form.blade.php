<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="altura" name="altura" type="number" class="mt-1 block w-full" :value="old('altura', $user->altura)" required autofocus autocomplete="altura" />
            <x-input-error class="mt-2" :messages="$errors->get('altura')" />
        </div>
        <div>
            <x-input-label for="peso" :value="__('Peso')" />
            <x-text-input id="peso" name="peso" type="number" class="mt-1 block w-full" :value="old('peso', $user->peso)" required autofocus autocomplete="peso" />
